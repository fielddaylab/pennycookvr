...
namespace Pennycook {
    public sealed class PenguinWeighGateSchedule : PenguinSchedule {
        public override IEnumerator Sequence(Process process) {
            ...
            while (true) {
                ...
                PenguinGatePositions p = brain.gameObject.GetComponent<PenguinGatePositions>();

                Vector3 targetWalkPos = p.GatePosIn.position;
                Vector3 targetWalkOutsidePos = p.GatePosOut.position;
                ...
                brain.ChangeActionState(PenguinStates.WeighGate, new PenguinWeighGateParams() {
                    Target = targetWalkPos,
                    Target2 = targetWalkOutsidePos
                });
