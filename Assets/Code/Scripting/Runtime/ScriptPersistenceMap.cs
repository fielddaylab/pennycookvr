...
namespace FieldDay.Scripting {
    /// <summary>
    /// Scripting persistence data.
    /// </summary>
    public sealed class ScriptPersistenceData {
        ...
        /// </summary>
        public RingBuffer<TimestampedNodeRecord> RecentlyViewedNodeIds = new RingBuffer<TimestampedNodeRecord>(HistorySize, RingBufferMode.Overwrite);
        ...
        public ScriptPersistenceData(int visitedNodeCapacity) {
