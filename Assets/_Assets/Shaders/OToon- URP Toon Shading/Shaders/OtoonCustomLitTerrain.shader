...
Shader "URP/OToonCustomLitTerrain"
{
    ...
    SubShader
    {
        Tags { "RenderType" = "Opaque" "RenderPipeline" = "UniversalPipeline" "UniversalMaterialType" = "SimpleLit" "IgnoreProjector" = "True" "ShaderModel" = "4.5" "TerrainCompatible" = "True" }
        LOD 300
